...
//           {(data as TableNodeData).name}
//           {targetPosition && (
//             <Handle
//               type="target"
//               id={(data as TableNodeData).name}
...
//                 <Link href={`/project/${(data as TableNodeData).ref}/editor/${(data as TableNodeData).id}`}>
...
//           {(data as TableNodeData).columns.map((column) => (
//             <div
//               className={cn(
